...
from .project import Arg, Decl, GithubInfo, Project, VersionSuite, Version
...
class GradleProject(Project):
    ...
    def __new__(cls, properties: Properties[Arg]):
        ...
        packageRoot = properties.get(
            "archives_base_name", Arg("", -1)).value
        ...
        stability = Arg(versionStability, modVersion.offset +
                        len(versionCoreValue))
