...
You can tweak the distance the scanner will try to reach, as well as width of the scaner cone and maximum number of echoes kept at any given time. Finally, you can select the kinds of ore the scanner should look for.

![Minimum values are: 4 meters for distance, single block for width and 10 visible echoes](docs/scanner_options_min.png) ![Maximum values are: 64 meters for distance, 21 by 21 meters for width and 200 visible echoes](docs/scanner_options_max.png)
...
![Main menu of scanner options](docs/scanner_options_main_menu.png)

![Main menu of scanner options, in game](docs/scanner_options_game_menu.png)
...
![Ore kind selection menu](docs/scanner_options_ore_selection.png)
